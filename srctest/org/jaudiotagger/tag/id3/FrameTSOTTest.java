...
public class FrameTSOTTest extends AbstractTestCase {
    ...
    public void testSaveToFile() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("test1010.mp3"));
    ...
    public void testSaveEmptyFrameToFile() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("test1011.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    public void testConvertV24ToV23() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("test1012.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    public void testConvertV24ToV22() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("test1013.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    public void testConvertV23ITunesToV22() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("test1014.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    public void testConvertV23MusicBrainzToV22() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("test1015.mp3"));
        MP3File mp3File = new MP3File(testFile);
