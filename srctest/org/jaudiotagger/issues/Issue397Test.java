...
public class Issue397Test extends AbstractTestCase {
    ...
    public void testSetSubtitleForMp3v22() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("testSetSubtitleForMp3v22.mp3"));
        AudioFile f = AudioFileIO.read(testFile);
    ...
    public void testSetSubtitleForMp3v23() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("testSetSubtitleForMp3v23.mp3"));
        AudioFile f = AudioFileIO.read(testFile);
    ...
    public void testSetSubtitleForMp3v24() throws Exception {
        File testFile = copyAudioToTmp("testV1.mp3", new File("testSetSubtitleForMp3v24.mp3"));
        AudioFile f = AudioFileIO.read(testFile);
