...
public class MetadataReader implements ChunkReader
{
    ...
    public Chunk read(final GUID guid, final DataSource dataSource, final long streamPosition) throws IOException
    {
        ...
        for (int i = 0; i < recordCount; i++)
        {
            ...
            final long dataLen = isExtDesc ? Utils.readUINT16(dataSource) : Utils.readUINT32(dataSource);
            assert dataLen >= 0;
            ...
            case MetadataDescriptor.TYPE_STRING:
                descriptor.setStringValue(Utils.readFixedSizeUTF16Str(dataSource, (int) dataLen));
                break;
            ...
            default:
                ...
                descriptor.setStringValue("Invalid datatype: " + new String(Utils.readBinary(dataSource, dataLen)));
            }
     ...
     *
     * @param dataSource stream to read from.
     * @param bytes  amount of bytes
     * @return <code>true</code> or <code>false</code>.
     * @throws IOException on I/O Errors
     */
    private boolean readBoolean(final DataSource dataSource, final int bytes) throws IOException
    {
